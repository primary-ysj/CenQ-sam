...
class P2Seg(TwoStageDetector):
    ...
    def forward_train(self,
        ...
        base_proposal_cfg = train_cfg.get('base_proposal',
                                               self.test_cfg.rpn)
        fine_proposal_cfg = train_cfg.get('fine_proposal',
                                               self.test_cfg.rpn)
        losses = dict()
    ...
    def simple_test(self, img, img_metas, gt_bboxes, gt_anns_id, gt_true_bboxes, gt_labels,
        ...
        for stage in range(self.num_stages):
            ...
            if stage == 0:
                ...
                if others is not None and 'reg_proposal_boxes' in others:
