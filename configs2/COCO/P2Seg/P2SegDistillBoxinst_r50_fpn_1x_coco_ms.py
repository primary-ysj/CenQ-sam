...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            num_ref_fcs=0,
            with_reg=True,
            # Emit regression proposals at PBR stage 1 so stage 2 receives
            # the continuous SPSD proposal set rather than a CBP regression.
            with_distill=2,
            with_sem=False,
            bbox_coder=dict(
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2000, 480), (2000, 576), (2000, 688), (2000, 800)],
...
load_from = None
work_dir = 'work_dirs/coco_p2seg'

evaluation = dict(
    interval=12, metric=['bbox', 'segm'],
