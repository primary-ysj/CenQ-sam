...
model = dict(
    ...
    roi_head=dict(
        ...
        # dict(type='Shared2FCInstanceMILHead',
        #      num_stage=2,
        #      in_channels=256,
        #      fc_out_channels=1024,
        #      roi_feat_size=7,
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2000, 480), (2000, 576), (2000, 688),(2000, 864)],
         multiscale_mode='value',
         keep_ratio=True),
    # dict(type='Resize', img_scale=[(2000, 480)],
    #      multiscale_mode='value',
    #      keep_ratio=True),
...
load_from = None
work_dir = 'work_dirs/coco_p2bnet'
